# rpi_arduino_fixed.py - Better debugging
import serial
import time
import requests
...
class ArduinoManager:
    ...
    def connect_arduino(self):
        ...
        try:
            ...
            print("✅ Serial port opened, waiting for Arduino...")
            ...
            print("\n❌ Arduino not sending ready message")
            print("💡 Check: Arduino code has 'Serial.println(\"ARDUINO_READY\")' in setup()")
            return False
            
        except Exception as e:
            print(f"❌ Serial connection failed: {e}")
            print("💡 Try: sudo usermod -a -G dialout $USER && sudo reboot")
            return False
...
def main():
    print("🤖 ARDUINO NANO + RPi 5 - DEBUG VERSION")
    print("=" * 50)
