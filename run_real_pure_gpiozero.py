# run_real_pure_gpiozero.py - Pure gpiozero for Pi 5
import sys
import os
import time
...
print("🤖 STARTING REAL HARDWARE MODE (Pure gpiozero)")

try:
    from real_sensor_manager_pure_gpiozero import RealSensorManager as SensorManager
    ...
    class RobotController:
        ...
        def start(self):
            print("=" * 50)
            print(f"🤖 REAL HARDWARE - {ROBOT_ID} (Pure gpiozero)")
            print("=" * 50)
            self.running = True
