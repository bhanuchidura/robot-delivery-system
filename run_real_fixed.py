# run_real_fixed.py - Fixed for Raspberry Pi 5
import sys
import os
import time
...
print("🤖 STARTING REAL HARDWARE MODE (Pi 5 FIXED)")

try:
    from real_sensor_manager_fixed import RealSensorManager as SensorManager
