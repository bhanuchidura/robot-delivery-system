# run_simulation.py - For PC simulation testing
import sys
import os
import time
...
try:
    from sim_sensor_manager import SimSensorManager as SensorManager
    from firebase_manager import FirebaseManager
    from config import ROBOT_ID, SENSOR_CHECK_INTERVAL, FIREBASE_UPDATE_INTERVAL

    class RobotController:
        def __init__(self):
            print(f"💻 Initializing SIMULATION for {ROBOT_ID}...")
